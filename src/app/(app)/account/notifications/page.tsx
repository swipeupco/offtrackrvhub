...
export default function NotificationSettingsPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Ensure defaults exist in state even before first upsert
      EVENTS.forEach(e => {
        if (!map[e.key]) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      ...
      <p className="text-sm text-gray-500 mb-8">Choose how you want to be notified about activity on your briefs.</p>
